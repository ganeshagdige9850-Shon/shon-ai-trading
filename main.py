...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        try:
            ...
            pass
        await update.message.reply_text("❌ Error झाला! पुन्हा try करा.")
...
📸 AI CHART ANALYSIS:
Chart/screenshot पाठवा bot ला
Bot automatically analyze करेल!
Buy/Sell/Hold सुचवेल!
...
• Dynamic Greeks (real values)
• Strike Recommendations
• Option Strategy (CE/PE/Spread)
• Entry, Target, SL
• Risk Management
...
def main():
    ...
    logger.info("🤖 Shon A.I. Advanced Bot starting...")
    ...
    # Photo handler for AI chart analysis
    app.add_handler(MessageHandler(filters.PHOTO, handle_photo))
    
    logger.info("✅ Bot running with AI Chart Analysis!")
